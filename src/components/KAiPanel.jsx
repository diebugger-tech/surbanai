...
import { useKAiChat } from '../hooks/useKAiChat';
...
const KAiPanel = ({ aktiveProjekt, onClose, onOpenWiki, dbReady = false }) => {
  const {
    input,
    setInput,
    messages,
    ...
    saveTitle,
    handleSend
  } = useKAiChat(aktiveProjekt, dbReady);
...
{searchQuery ? `   _____ ___  __ 
  ...
  |_|\\_|___\\___/ `}
      ...
      <ChatArea
        ...
        aktivesModel={aktivesModel}
        onModellWechsel={handleModellWechsel}
        ...
        onClose={onClose}
        aktiveProjekt={aktiveProjekt}
        wikiContextCount={wikiContextCount}
      />
    </div>
  );
};
